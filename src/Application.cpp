...
static void FramebufferResizeCallback(GLFWwindow* window, int width, int height)
{
    ...
    app->SetFramebufferChangedFlag(true);
}
...
void Application::CreateGraphicsPipeline()
{
    ...
    rasterizer.depthBiasEnable = VK_FALSE; // could be usefull for shadow mapping
...
void Application::CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkBuffer& buffer, VkDeviceMemory& bufferMemory)
{
    ...
    if(vkAllocateMemory(m_Device, &allocInfo, nullptr, &bufferMemory) != VK_SUCCESS)
        throw std::runtime_error("failed to allocate bufer memory");
...
void Application::CreateTextureImage()
{
    ...
    stbi_uc* pixels = stbi_load("../../../../res/textures/abby_lee_miller.png", &textureWidth, &textureHeight, &textureChannels, STBI_rgb_alpha);
    VkDeviceSize imageSize = textureWidth * textureHeight * 4;

    if(!pixels)
        throw std::runtime_error("Failed to load texture image!");

    // Creating a staging buffer for the image
    VkBuffer stagingBuffer;
    VkDeviceMemory stagingBufferMemory;
    ...
    CreateImage(static_cast<uint32_t>(textureWidth), static_cast<uint32_t>(textureHeight), VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL,
    ...
    CopyBufferToImage(stagingBuffer, m_TextureImage, textureWidth, textureHeight);
